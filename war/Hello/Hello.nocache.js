...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "Hello" because\n';
 ...
 * "/Hello.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['Hello'].superdevmode = true;

  var expectedSuffix = '/Hello.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + Hello + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:Hello';
  var devModeSessionKey = '__gwtDevModeSession:Hello';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':60465';
  var nocacheUrl = serverUrl + '/Hello/Hello.nocache.js';
  ...
  $wnd.__gwt_activeModules['Hello'].canRedirect = true;
  $wnd.__gwt_activeModules['Hello'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/Hello?user.agent=' + ua + '&_callback=' + callback;
